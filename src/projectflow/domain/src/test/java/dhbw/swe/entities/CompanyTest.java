...
class CompanyTest {
    ...
    void createProject_exceedingBudget() {
        ...
        assertThrows(IllegalArgumentException.class, () -> company
                .createProject("Too Expensive (fails)", Money.euro(200_000), TestSetup.DURATION));
    }
    ...
    void createProject_withNegativeBudget() {
        ...
        assertThrows(IllegalArgumentException.class, () -> company
                .createProject("Negative Budget (fails)", Money.euro(-50_000), TestSetup.DURATION));
    }

    @Test
    void createProject_secondProject_respectsCumulativeBudget() {
        Company company = setup.createCompanyWithBudget(Money.euro(100_000));
        setup.createProjectWithBudget(company, Money.euro(80_000));

        assertThrows(IllegalArgumentException.class,
                () -> company.createProject("Over Cumulative Budget (fails)", Money.euro(40_000),
                        TestSetup.DURATION));
    }
}
